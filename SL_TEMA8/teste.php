...
<div class="container">
    ...
    function verificarSensorVazamentoGas() {
    ...
    // Verifica se o sensor de vazamento_gas foi acionado
    if (verificarSensorVazamentoGas()) {
        $sensores_acionados[] = 'vazamento_gas';
    }

    // Verifica se o sensor de invasao foi acionado
